...
DEFAULT_CLUSTER="bia"
DEFAULT_SERVICE="task-def-bia-service-yy6t6pom"
...
create_task_definition() {
    ...
    local register_result=$(aws ecs register-task-definition --region $region --cli-input-json file://"$new_temp_file" 2>/dev/null)
